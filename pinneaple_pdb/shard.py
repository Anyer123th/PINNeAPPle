...
def iter_time_windows(time_values, window: str) -> Iterator[Tuple[pd.Timestamp, pd.Timestamp]]:
...
def subset_tile(ds: xr.Dataset, lat0: float, lat1: float, lon0: float, lon1: float) -> xr.Dataset:
