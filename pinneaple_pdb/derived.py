...
def _infer_uv(ds: xr.Dataset, u_name: Optional[str], v_name: Optional[str]) -> Tuple[str, str]:
...
def add_vorticity_divergence(ds: xr.Dataset, u_name: Optional[str]=None, v_name: Optional[str]=None) -> xr.Dataset:
